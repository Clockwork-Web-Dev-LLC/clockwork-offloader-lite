				...
				<?php while ( $attachments_query->have_posts() ) : $attachments_query->the_post(); ?>
					...
					<tr>
						...
						<td class="column-actions">
							<?php if ( $is_offloaded ) : ?>
								<button type="button" class="button button-small clockwork-restore-btn" data-attachment-id="<?php echo esc_attr( $attachment_id ); ?>">
									<?php esc_html_e( 'Restore', 'clockwork-offloader' ); ?>
								</button>
							<?php else : ?>
								<button type="button" class="button button-primary button-small clockwork-offload-btn" data-attachment-id="<?php echo esc_attr( $attachment_id ); ?>">
									<?php esc_html_e( 'Offload', 'clockwork-offloader' ); ?>
								</button>
							<?php endif; ?>
							<span class="spinner clockwork-action-spinner" data-attachment-id="<?php echo esc_attr( $attachment_id ); ?>" style="float: none; margin-left: 5px; visibility: hidden;"></span>
						</td>
					</tr>
				<?php endwhile; ?>
			</tbody>
