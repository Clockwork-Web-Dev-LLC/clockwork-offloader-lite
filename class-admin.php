...
class Clockwork_Offloader_Admin {
	...
	public function add_admin_menu() {
		...
		if ( is_multisite() && is_network_admin() ) {
			...
			add_menu_page(
				__( 'Clockwork Offloader', 'clockwork-offloader' ),
				__( 'Clockwork Offloader', 'clockwork-offloader' ),
	...
	public function register_settings() {
		...
		add_settings_field(
			'auto_offload',
			__( 'Auto-Offload', 'clockwork-offloader' ),
	...
	public function render_auto_offload_field() {
		...
		<label class="clockwork-toggle-wrapper">
			...
			<span class="clockwork-toggle-label"><?php esc_html_e( 'Automatically offload new media uploads to S3', 'clockwork-offloader' ); ?></span>
		</label>
		<?php
	}
	...
	public function render_delete_after_upload_field() {
		...
		<p class="description"><?php esc_html_e( 'Warning: This will permanently delete files from your server. Make sure you have backups.', 'clockwork-offloader' ); ?></p>
		<?php
	}
				...
				<div class="clockwork-offloader-header-content">
					<div class="clockwork-offloader-header-left">
						...
						<div class="clockwork-offloader-title">
							<h1><?php esc_html_e( 'Clockwork Offloader', 'clockwork-offloader' ); ?></h1>
						</div>
					</div>
